...
namespace ProjectMamagerBll . Dao
{
    public class MainDao
    {
        ...
        {
            StringBuilder strSql = new StringBuilder ( );
            strSql . AppendFormat ( "SELECT HBB004,CASE WHEN HBB006-HBB024=0 THEN '已采买' ELSE '未采'+CONVERT(VARCHAR,CONVERT(FLOAT,HBB006-HBB024))+'数量' END HBB,HDA960,DGA002,CONVERT(FLOAT,HDA041) HDA041,HDB010,HDA961,HDB960,HDB001,HDB002 FROM DCSHBA A INNER JOIN DCSHBB B ON A.HBA001=B.HBB001 INNER JOIN DCSHDB C ON B.HBB001=C.HDB014 AND B.HBB002=C.HDB015 INNER JOIN DCSHDA D ON C.HDB001=D.HDA001 INNER JOIN TPADGA E ON D.HDA004=E.DGA001 WHERE HDB019='T' AND HBB009='T' AND HBA006='{0}'" ,num );
